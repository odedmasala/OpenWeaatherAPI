...
let changeWeather = (response, temp) => {
  if (temp <= 0) {
    ...
    response === "overcast cloud" ||
    response === "scatterred cloud" ||
...
btn.addEventListener("click", function () {
  ...
  if (cityName != "") {
    ...
    let humidity;
    let time = new Date();
    let API_KEY = "2ce3b01a0054a972d3dadd13b092cfef";
    ...
    xhr.onload = function () {
      ...
      console.log(data);
      deac = data.weather[0].description;
      temp = data.main.temp;
